...
class li3DModSkeletalMesh : public li3DSkeletalMesh
{
public:
	//
	virtual void SetCharacterName(const std::string &character_name) = 0;
	//
	li3DModSkeletalMesh()
	{}
	//
	virtual ~li3DModSkeletalMesh() override
	{}
};
...
public:
	...
	virtual void VisitSkeletalMesh(li3DModSkeletalMesh &skeletal_mesh) = 0;
	//
	li3DModMeshVisitor()
	{}
	//
