...
void lrGL3DCachedLayer::DrawScene()
{
	...
	lrGLStaticMeshShader StaticMeshShader = RenderState3D.GetStaticMeshPointLightShader();
	lrGL3SceneCacher SceneCacher(ResourceLoader,StaticMeshShader,SceneCache);
