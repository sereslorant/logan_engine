...
public:
	...
	public:
		...
		virtual li3DModElement *CreateSkeletalMesh(const lmVector3D &position,const lmQuaternion &orientation,const lmVector3D &scale,const liMaterialLibrary &mtl_lib,const std::string &character_name) = 0;
